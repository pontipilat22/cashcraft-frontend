  ...
  help: {
    ...
    questions: {
      ...
      exchangeRates: {
        ...
        answer: 'В настройках выберите "Курсы валют". Приложение поддерживает автоматическое обновление курсов через интернет или ручной ввод. Каждый счёт может иметь свой курс обмена.',
      },
      dataSync: {
      ...
      exportData: {
        ...
        answer: 'Перейдите в "Ещё" → "Экспорт и импорт данных". Вы можете экспортировать данные в формате JSON для резервного копирования или переноса на другое устройство. Также поддерживается импорт ранее экспортированных данных.',
      },
      savings: {
      ...
      premium: {
        ...
        answer: 'Premium снимает ограничение на количество счетов (в бесплатной версии - 2 счёта), даёт доступ к расширенной статистике, синхронизации между устройствами и приоритетной поддержке.',
      },
      security: {
