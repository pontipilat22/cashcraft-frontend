export default {
  ...
  plans: {
    ...
    budgetSystemSettings: 'Budget System Settings',
    budgetSystemDescription: 'Manage your 50/30/20 budget system for effective income distribution',
    budgetRule: 'Budget Rule',
    enableBudget: 'Enable Budget System',
    enableBudgetSystem: 'Enable Budget System',
    disableBudget: 'Disable Budget System',
    essentialExpenses: 'Essential Expenses',
    nonEssentialExpenses: 'Non-Essential Expenses',
    savings: 'Savings',
    customizePercentages: 'Customize Percentages',
    ...
    budgetSystemInfo: '50/30/20 rule: 50% for essential expenses (housing, food), 30% for non-essential (entertainment), 20% for savings',
    monthlyIncome: 'Monthly Income',
    setMonthlyIncome: 'Set Monthly Income',
    incomeRequired: 'Please set your monthly income to use the budget system',
    includeBudgetSystem: 'Include in budget system',
    budgetDistribution: 'Budget distribution',
    dailyBudget: 'Daily Budget',
    spentToday: 'Spent Today',
    canSpendToday: 'Can Spend Today',
    dailyAllowance: 'Daily allowance',
    budgetTrackingEnabled: 'Income will be distributed across budget categories',
    budgetTrackingDisabled: 'Income will not be tracked in budget system',
    currentMonth: 'Current Month',
    addIncomeToStart: 'Add income to start working with budget',
    essential: 'Essential',
  ...
  categories: {
    ...
    budgetSettings: 'Budget Category Settings',
    budgetSettingsDescription: 'Set whether each expense category is essential or non-essential for budget tracking',
  ...
  pin: {
    ...
    set: 'PIN has been set',
    changed: 'PIN has been changed',
    disabled: 'PIN has been disabled',
    error: 'Error working with PIN',
    forgot: 'Forgot PIN?',
    forgotTitle: 'Forgot PIN',
    forgotMessage: 'To reset PIN, you need to log out. All local data will be preserved.',
    attemptsRemaining: 'attempts remaining',
    tooManyAttempts: 'Too many incorrect attempts',
    lockedOut: 'Locked out. Try again in',
    disableTitle: 'Disable PIN',
    disableMessage: 'Are you sure you want to disable PIN protection?',
  },
  credit: {
    notFound: 'Credit not found',
    loading: 'Loading...',
    noData: 'Insufficient data to display payment schedule',
    remainingDebt: 'Remaining debt',
    paid: 'Paid',
    ...
    amountExceedsPayment: 'Amount cannot exceed payment amount',
    paymentError: 'Error marking payment',
    ...
    earlyRepaymentExceedsDebt: 'Amount cannot exceed remaining debt',
    earlyRepaymentError: 'Error during early repayment',
  },
  ai: {
